...
//import androidx.activity.compose.BackHandlers
...
import reply.composeapp.generated.resources.*
import reply.composeapp.generated.resources.Res
import reply.composeapp.generated.resources.app_name
import reply.composeapp.generated.resources.compose
import reply.composeapp.generated.resources.navigation_drawer
...
fun ReplyNavigationRail(
    ...
    NavigationRail(
        ...
        //FIXME: containerColor = MaterialTheme.colorScheme.inverseOnSurface
    ) {
        Column(
...
//               FIXME: containerColor = MaterialTheme.colorScheme.tertiaryContainer,
//               FIXME: contentColor = MaterialTheme.colorScheme.onTertiaryContainer
            ) {
                Icon(
                ...
                NavigationRailItem(
                    ...
                    icon = {
                        Icon(
                            ...
                            contentDescription = replyDestination.iconTextId.toString()
                        )
                    }
                )
            }
                ...
                Column(
                    ...
                    TOP_LEVEL_DESTINATIONS.forEach { replyDestination ->
                        NavigationDrawerItem(
                            ...
                            label = {
                                Text(
                                    text = replyDestination.iconTextId.toString(),
                ...
                Column(
                    ...
                    Row(
                        ...
                        IconButton(onClick = onDrawerClicked) {
                            Icon(
                                imageVector = FeatherIcons.ChevronsLeft,
